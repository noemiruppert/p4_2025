...
Im ersten Versuchsteil wird eine Goldkugelprobe untersucht. Um die Leitfähigkeit von der Probe sicherzustellen, wurde Gold auf Silizium aufgedampft. Die Oberfläche wurde unter dem Mikroskop vergrößert (siehe Abbildung %addref
 ...
 verwendet.
 %add picture of the gold probe under the microscope
\begin{figure}[H]
    \centering
...
Die verarbeiteten Bilder sind in den Abbildungen %addref
dargestellt. Sie zeigen das Höhenprofil sowohl im 2D- als auch im 3D-Format, ergänzt durch die entsprechenden Strombilder.
